...
<ul class="space-y-0.5 px-3">
    ...
    <li>
        <a href="{{ route('reimburse.review') }}"
           style="{{ request()->routeIs('reimburse.review') ? 'background:#dc2626;color:white;' : '' }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition text-gray-300 hover:text-white"
           onmouseover="{{ request()->routeIs('reimburse.review') ? '' : "this.style.background='rgba(220,38,38,0.15)'" }}"
           onmouseout="{{ request()->routeIs('reimburse.review') ? '' : "this.style.background=''" }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg> Review Reimburse
            @php $pendingReimburse = \App\Models\Reimburse::where('status','pending')->count(); @endphp
    ...
    <li>
        <a href="{{ route('reimburse.index') }}"
           style="{{ request()->routeIs('reimburse.index') || request()->routeIs('reimburse.create') ? 'background:#dc2626;color:white;' : '' }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition text-gray-300 hover:text-white"
           onmouseover="{{ request()->routeIs('reimburse.index') || request()->routeIs('reimburse.create') ? '' : "this.style.background='rgba(220,38,38,0.15)'" }}"
           onmouseout="{{ request()->routeIs('reimburse.index') || request()->routeIs('reimburse.create') ? '' : "this.style.background=''" }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" /></svg> Reimburse Saya
        </a>
    </li>
    <li>
...
<ul class="space-y-0.5 px-3">
    ...
    <li>
        <a href="{{ route('pengeluaran.index') }}"
           style="{{ request()->routeIs('pengeluaran.*') ? 'background:#dc2626;color:white;' : '' }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition text-gray-300 hover:text-white"
           onmouseover="{{ request()->routeIs('pengeluaran.*') ? '' : "this.style.background='rgba(220,38,38,0.15)'" }}"
           onmouseout="{{ request()->routeIs('pengeluaran.*') ? '' : "this.style.background=''" }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" /></svg> Pengeluaran
        </a>
    </li>
    @endif
