...
@if($barang->has_sn)
<div class="bg-white rounded-xl shadow p-4">
    <h2 class="font-semibold text-gray-700 mb-3 text-sm flex items-center gap-2"><svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.5-15-6 18m-3-18-6 18" /></svg>Daftar Serial Number</h2>
    <div class="hidden md:block overflow-x-auto">
        <table class="w-full text-sm">
            <thead class="bg-gray-50 text-gray-500 uppercase text-xs">
                <tr>
